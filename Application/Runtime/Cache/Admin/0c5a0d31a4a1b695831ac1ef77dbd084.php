                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <form action="<?php echo (C("GOTO")); ?>Admin/Student/modify" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-file-input">已上传标题图片</label>
                                            <div class="col-md-9">
