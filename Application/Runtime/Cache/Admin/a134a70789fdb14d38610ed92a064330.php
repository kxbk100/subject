                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/Time/showManage" class="active">
                                                大事记删改
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    ...
                                    <tbody>
                                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo (C("GOTO")); ?>Admin/Time/showModify?id=<?php echo ($vo["id"]); ?>" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success">
                                                        <i class="fa fa-pencil">
                                                        </i>
                                                    </a>
                                                    <a onclick="return del()" href="<?php echo (C("GOTO")); ?>Admin/Time/delete?id=<?php echo ($vo["id"]); ?>" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger">
                                                        <i class="fa fa-times">
                                                        </i>
                                                    </a>
                                                </td>
