		...
		<section class="section full-width-bg gray-bg">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newss): $mod = ($i % 2 );++$i;?><div class="blog-post big">
						<div class="post-image">
							<div class="tp-banner-container">
								<div class="tp-banner-small">
									<ul>
										<?php if(is_array($newss)): $i = 0; $__LIST__ = $newss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><li data-transition="boxfade" data-link="#">
												<img src="<?php echo ($news["titlephoto"]); ?>" alt="">
						...
						<?php if(is_array($newss)): $i = 0; $__LIST__ = $newss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><div>
							<h4 class="post-title">
                            <?php if($news["istop"] == 1): ?>[置顶]<?php endif; ?>
                            <a href="<?php echo (C("GOTO")); ?>Home/News/showNews/<?php echo ($news["id"]); ?>"><?php echo ($news["title"]); ?></a></h4>
							<p><a>[<?php echo ($news["time"]); ?>]</a> <?php echo (msubstr($news["content"],0,35,'utf-8',true)); ?>
								<!--限定字数--><a href="<?php echo (C("GOTO")); ?>Home/News/showNews/<?php echo ($news["id"]); ?>" class="pull-right">[MORE]</a>
							</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 sidebar">
					...
					<!-- Upcoming Events -->
					<div class="sidebar-box white" style="padding-top:10px;margin-top: 0px;">
						<h3><i class="icon-camera"></i>
                        <span style="padding-left:30px;padding-right: 15px;color: #4174c5;font-size: 23px;"
                              id="content1"
                              onmouseover="changeContent(this)">公告通知</span><span style="font-size:24px;">|</span>
                        <span style="padding-left: 8px;font-size: 23px;" id="content2"
                              onmouseover="changeContent(this)">学术活动</span>
                    </h3>
						<div id="right">
			...
			<div id="lower-footer">
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 animate-onscroll">
						<p class="copyright text-center">Copyright © 2012-2017 ZUST ITEE All Rights Reserved 浙江科技学院 信息与电子工程学院 版权所有</p>
					</div>
