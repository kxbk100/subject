                ...
                <ul id="navigation">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/2">硕士点介绍</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/3">项目立项</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/4">论文发表</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/5">专著教材</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/6">知识产权</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/7">项目介绍</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/8">竞赛介绍</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/9">竞赛获奖</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/10">本科教育</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/11">研究生教育</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/12">师资力量</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/13">硬件条件</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/14">校企合作</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/15">招生简章</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/16">招生通知</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/17">招生流程</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/18">招生问答</a></li>
                            <li><a href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages/19">联系我们</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="col-lg-9 col-md-9 col-sm-8">
                    ...
                    <div class="blog-post-single">
                        ...
                        <div class="post-meta animate-onscroll">
                            <span>时间：<?php echo ($result['time']); ?></span>
                        </div>
                        ...
                        <div class="row animate-onscroll">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 button-pagination align-left">
                                <a href="<?php echo (C("GOTO")); ?>Home/Student/showStudent/<?php echo ($result['pre']); ?>" class="button big previous">上一篇</a>
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-6 button-pagination align-right">
                                <a href="<?php echo (C("GOTO")); ?>Home/Student/showStudent/<?php echo ($result['next']); ?>" class="button big next">下一篇</a>
                            </div>
