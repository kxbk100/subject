                ...
                <div class="sidebar-content">
                    ...
                    <ul class="sidebar-nav">
                        <li class="active">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo (C("GOTO")); ?>Admin/Notice/showAdd" class="active">公告发布</a>
                                </li>
                                <li>
         ...
         <div id="main-container">
            ...
            <div id="page-content">
                ...
                <div class="block full">
                    ...
                    <!-- Get Started Content -->
                    <form action="<?php echo (C("GOTO")); ?>/Admin/Notice/add" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="example-text-input" name="author" class="form-control" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="example-text-input">分类</label>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-1 control-label"><input type="radio" name="first" value="1" id="example-text-input"/>是</label>
                            <label class="control-label"><input type="radio" name="first" value="0" checked="checked"/>否</label>
                        </div>
                        <div class="form-group">
