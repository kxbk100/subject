                ...
                <div class="sidebar-content">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo (C("GOTO")); ?>Admin/Admissions/showAdd" class="active">招生信息发布</a>
                                </li>
                                <li>
         ...
         <div id="main-container">
            ...
            <div id="page-content">
                ...
                <div class="block full">
                    ...
                    <!-- Get Started Content -->
                    <form action="<?php echo (C("GOTO")); ?>/Admin/Admissions/add" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
