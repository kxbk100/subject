                                ...
                                <div class="blog-post animate-onscroll">
                                    <div class="post-content">
                                        ...
                                        <div class="post-header">
                                            <h2><a href="<?php echo (C("GOTO")); ?>Home/News/showNews/<?php echo ($vo["id"]); ?>">2017年招生简章</a>
                                            </h2>
                                        </div>
                                        <div class="post-header">
                                            <h2><a href="<?php echo (C("GOTO")); ?>Home/Notice/showNotice/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h2>
                                            <div class="post-meta">
                                                <span>分类：[<a>招生简章</a>]</span>
                                            </div>
                                        </div>
                            ...
                            <div class="list-passage">
                                <div class="blog-post animate-onscroll">
                                    <div class="post-content">
                                        ...
                                        <div class="post-header">
                                            <h2><a href="<?php echo (C("GOTO")); ?>Home/News/showNews/<?php echo ($vo["id"]); ?>">2017年招生通知</a>
                                            </h2>
                                        </div>
                                        <div class="post-header">
                                            <h2><a href="<?php echo (C("GOTO")); ?>Home/Notice/showNotice/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h2>
                                            <div class="post-meta">
                                                <span>分类：[<a>招生通知</a>]</span>
                                            </div>
                                        </div>
