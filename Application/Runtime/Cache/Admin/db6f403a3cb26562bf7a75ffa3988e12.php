...
<!--[if gt IE 9]><!-->
<html class="no-js" lang="zh-cn" xmlns="http://www.w3.org/1999/html">
    <!--
    <![endif]-->
    <head>
        <meta charset="utf-8"/>
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/News/showAdd" class="active">
                                                学科动态发布
                                            </a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <form action="<?php echo (C("GOTO")); ?>Admin/News/add" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label">
                                        <input type="radio" name="first" value="0" checked="checked"/>
                                        否
                                    </label>
                                </div>
                                <div class="form-group">
