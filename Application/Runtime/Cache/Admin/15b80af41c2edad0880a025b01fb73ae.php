                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/Passages/showManage" class="active">文章修改</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo (C("GOTO")); ?>Admin/Passages/showModify?id=<?php echo ($vo["id"]); ?>" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                            </td>
