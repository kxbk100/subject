                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/Time/showAdd"  class="active">大事记发布</a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <!-- Get Started Content -->
                            <form action="<?php echo (C("GOTO")); ?>/Admin/Time/add" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-select2">年份</label>
                                            <div class="col-md-5">
                                                <select id="example-select2" name="year" class="select-select2" style="width: 100%;" >
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">月份</label>
                                            <div class="col-md-5">
                                                <select id="example-select2" name="month" class="select-select2" style="width: 100%;" >
