                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <!-- Get Started Content -->
                            <form action="<?php echo (C("GOTO")); ?>Admin/Notice/modify" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <select name="type" class="form-control">
                                            <option value="0" <?php if($result['type'] == 0): ?>selected="selected"<?php endif; ?> >
                                                公告通知
                                            </option>
                                            <option value="1" <?php if($result['type'] == 1): ?>selected="selected"<?php endif; ?> >
                                                学术活动
                                            </option>
                                        </select>
                                    </div>
