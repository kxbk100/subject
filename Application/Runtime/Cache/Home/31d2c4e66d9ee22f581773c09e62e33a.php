    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (x.substr(x.length - 1, 1) == 5) {
                ...
                let title = $('h4')[1];
                $(title).css('color', "white");
            } else if (x.substr(x.length - 1, 1) == 7) {
                let child = $('.banner')[2];
                $(child).css('background', "rgb(99,178,245)");
                let title = $('h4')[2];
                $(title).css('color', "white");
            } else if (x.substr(x.length - 1, 1) == 8) {
                let child = $('.banner')[3];
                $(child).css('background', "rgb(99,178,245)");
                let title = $('h4')[3];
                $(title).css('color', "white");
    ...
    <section id="content">
        ...
        <section class="section page-heading animate-onscroll">
            ...
            <p class="breadcrumb">
                ...
                <?php echo ($result['second']); ?>
                <?php if($result['third'] != ''): ?>-><?php endif; ?>
                <?php echo ($result['third']); ?>
            </p>
        </section>
        <!-- Page Heading -->
        <!-- Section -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 sidebar">
                    <div class="sidebar-box white">
                        ...
                        <?php if(is_array($third)): $i = 0; $__LIST__ = $third;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="banner-wrapper">
                                <a class="banner" href="<?php echo (C("GOTO")); ?>Home/Passages/showPassages3/<?php echo ($vo["id"]); ?>">
                    ...
                    <div class="hidden-xs">
                        ...
                        <div class="sidebar-box white">
                            <h3><span style="padding-right: 8px;color: #4174c5;" id="content1"
                                ...
                                <span style="padding-left: 3px;" id="content2"
