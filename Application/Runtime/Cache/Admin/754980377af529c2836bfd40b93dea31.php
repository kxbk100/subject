                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/Notice/showAdd" class="active">
                                                公告发布
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo (C("GOTO")); ?>Admin/Time/showAdd"  class="active">
                                                大事记发布
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div class="block full">
                            ...
                            <form action="<?php echo (C("GOTO")); ?>/Admin/Time/add" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="date" id="example-text-input" name="date" class="form-control" required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
